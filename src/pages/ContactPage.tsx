...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setStatus("Message sent! (This is a demo - not actually sent)");
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white">joaquin@example.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all border border-white/20"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-all"
                  >
