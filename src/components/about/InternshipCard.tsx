  ...
  return (
    ...
    >
      <div className="card-content">
        <p className="text-black/60 text-[10px] lg:text-xs uppercase tracking-wider font-medium mb-2">Most Recent Experience</p>
      ...
      <div className="h-24 lg:h-32 w-full flex items-center justify-center">
        <Image
          src="/sikorsky.png"
          alt="Sikorsky Logo"
          className="h-28 w-52 object-contain rounded-xl"
          width={208}
          height={112}
        />
      </div>
